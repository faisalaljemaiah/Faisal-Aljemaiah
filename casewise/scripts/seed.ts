...
const authors: SeedAuthor[] = [
  ...
  {
    email: "seed.marcus@casewise.dev",
...
const cases: SeedCase[] = [
  {
    authorEmail: "seed.amina@casewise.dev",
  ...
  {
    authorEmail: "seed.marcus@casewise.dev",
  ...
  {
    authorEmail: "seed.priya@casewise.dev",
  ...
  {
    authorEmail: "seed.tom@casewise.dev",
  ...
  {
    authorEmail: "seed.layla@casewise.dev",
  ...
  {
    authorEmail: "seed.diego@casewise.dev",
