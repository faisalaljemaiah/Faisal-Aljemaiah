...
export default function CounselingCasePage() {
  ...
  const [result, setResult] = React.useState<{ score: number; points_awarded: number } | null>(null)
  ...
  async function handleSubmit() {
    ...
    try {
      ...
      setResult({ score: attempt.score, points_awarded: attempt.points_awarded })
          ...
          <CardContent className="space-y-3">
            {result ? (
              ...
              <>
                ...
                <Button className="w-full" onClick={handleSubmit} disabled={submitAttempt.isPending || covered.size === 0}>
